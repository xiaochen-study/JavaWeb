...
<div id="orderInfo_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="orderInfoQueryForm" method="post">
			...
			<input class="textbox" type="hidden" id="doctorObj_doctorNumber_query" name="doctorObj.doctorNumber" value="<%=session.getAttribute("doctor") %>" style="width: auto"/>
...
<div id="orderInfoEditDiv">
	<form id="orderInfoEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<select id="orderInfo_checkState_edit" name="orderInfo.checkState">
...
<script type="text/javascript" src="OrderInfo/js/orderInfo_doctor_manage.js"></script> 
