		...
		<div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#orderInfoAdd" aria-controls="orderInfoAdd" role="tab" data-toggle="tab">登记预约信息</a></li>
				</ul>
				<!-- Tab panes -->
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="orderInfoAdd"> 
						  ...
						  <div class="form-group" style="display:none;">
						  	 ...
						  	 <div class="col-md-8">
							    <input type="text" id="orderInfo_checkState" name="orderInfo.checkState" value="待处理" class="form-control" placeholder="请输入处理状态">
							 </div>
						  </div>
						  <div class="form-group" style="display:none;">
				          ...
				          <div class="form-group">
				             ...
				             <span onclick="ajaxOrderInfoAdd();" class="btn btn-primary bottom5 top5">提交预约</span>
				          </div>
						</form> 
...
var basePath = "<%=basePath%>";
	...
	function ajaxOrderInfoAdd() { 
		...
		jQuery.ajax({
			type : "post",
			url : basePath + "OrderInfo/userAdd",
			dataType : "json" , 
...
$(function(){
	...
	$.ajax({
		...
		success: function(doctors,response,status) { 
    		...
    		$("#orderInfo_doctorObj_doctorNumber").val('<%=request.getParameter("doctorNumber") %>');
    	}
	});
	//预约日期组件
